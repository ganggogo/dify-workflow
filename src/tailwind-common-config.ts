...
const iconFromRi = (name: string) => {
  const icon = ri.icons[name]

  if (!icon)
    throw new Error(`Missing fallback icon: ri:${name}`)

  return icon
}

const customVenderIcons = {
  'line-files-copy': iconFromRi('file-copy-line'),
  'line-files-copy-check': iconFromRi('file-check-line'),
  'solid-mediaAndDevices-stop-circle': iconFromRi('stop-circle-line'),
  'line-general-hash-02': iconFromRi('hashtag'),
  'line-arrows-arrow-up-right': iconFromRi('corner-up-right-line'),
  'line-editor-type-square': iconFromRi('text'),
  'line-general-target-04': iconFromRi('target-line'),
  'line-editor-bezier-curve-03': iconFromRi('node-tree'),
  'solid-general-check-circle': iconFromRi('checkbox-circle-fill'),
  'workflow-trigger-all': iconFromRi('play-circle-line'),
  'line-financeandecommerce-balance': iconFromRi('scales-3-line'),
  'solid-alertsandfeedback-alert-triangle': iconFromRi('alert-fill'),
  'solid-general-x-circle': iconFromRi('close-circle-fill'),
  'solid-general-arrow-down-round-fill': iconFromRi('arrow-down-circle-fill'),
  'line-general-check': iconFromRi('check-line'),
  'line-arrows-refresh-ccw-01': iconFromRi('refresh-line'),
  'line-time-clock-play': iconFromRi('time-line'),
  'line-time-clock-play-slim': iconFromRi('time-line'),
  'line-alertsAndFeedback-alert-triangle': iconFromRi('alert-line'),
  'solid-files-file-05': iconFromRi('file-3-line'),
  'solid-files-folder': iconFromRi('folder-3-fill'),
  'line-general-checklist-square': iconFromRi('list-check-3'),
  'other-replay-line': iconFromRi('refresh-line'),
}

const customPublicIcons = {}
  ...
  plugins: [
    ...
    iconsPlugin({
      collections: {
        heroicons,
        ri,
        'custom-public': { icons: customPublicIcons },
        'custom-vender': { icons: customVenderIcons },
      },
      extraProperties: {
        width: '1rem',
        height: '1rem',
